...
/* harmony import */ var _actions_text_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actions/text-editor */ "./resources/js/actions/text-editor.js");

/* harmony default export */ __webpack_exports__["default"] = ({
  general: [_actions_text_editor__WEBPACK_IMPORTED_MODULE_0__["default"]]
});

/***/ }),

/***/ "./resources/js/actions/text-editor.js":
/*!*********************************************!*\
  !*** ./resources/js/actions/text-editor.js ***!
  \*********************************************/
/*! exports provided: default */
...
function textEditor() {
  var targets = document.querySelectorAll('[data-wysiwyg]');

  for (var i = 0; i < targets.length; i++) {
    var target = targets[i]; // const editorInstance = new SimpleMDE({ element: target });
  }
}
;
...
(function () {
  var tag = document.body.getAttribute('data-page-id');

  var runActions = function runActions(tag) {
    var _actions = _actions__WEBPACK_IMPORTED_MODULE_0__["default"][tag];

    if (typeof _actions !== "undefined") {
      _actions.forEach(function (action) {
        return action.call(window);
      });
    }
  };
